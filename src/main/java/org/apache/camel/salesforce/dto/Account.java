...
public class Account extends AbstractSObjectBase {
    ...
    // Twitter_Hashtag__c
    private String Twitter_Hashtag__c;

    @JsonProperty("Twitter_Hashtag__c")
    public String getTwitter_Hashtag__c() {
        return this.Twitter_Hashtag__c;
    }

    @JsonProperty("Twitter_Hashtag__c")
    public void setTwitter_Hashtag__c(String Twitter_Hashtag__c) {
        this.Twitter_Hashtag__c = Twitter_Hashtag__c;
    }
}